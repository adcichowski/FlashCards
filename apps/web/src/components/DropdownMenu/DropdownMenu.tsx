...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger ref={ref} className={clsx(styles.subTrigger, className)} {...props}>
    {children}
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent ref={ref} className={clsx(styles.subContent, className)} {...props} />
));
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item ref={ref} className={clsx(styles.item, className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Separator ref={ref} className={clsx(styles.separator, className)} {...props} />
));
